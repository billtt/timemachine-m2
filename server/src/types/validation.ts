import { z } from 'zod';
import { SLICE_TYPES } from '../../../shared/types';
...
export const sliceQuerySchema = z.object({
  ...
  type: z.enum(SLICE_TYPES).optional().or(z.literal('')).transform(val => val === '' ? undefined : val),
